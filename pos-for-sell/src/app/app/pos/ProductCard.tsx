...
export function ProductCard({
  ...
  return (
    <button
      ...
      className="group grid gap-1 rounded-2xl border border-[color-mix(in_oklch,var(--color-accent)_12%,transparent)] bg-gradient-to-b from-[#ffffff] via-[#faf8fd] to-[#efeafd] p-2 text-left shadow-[0_10px_20px_rgba(28,24,56,0.05)] transition hover:-translate-y-px hover:shadow-[0_16px_28px_rgba(28,24,56,0.10)] disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0 disabled:hover:shadow-[0_10px_20px_rgba(28,24,56,0.05)]"
    >
