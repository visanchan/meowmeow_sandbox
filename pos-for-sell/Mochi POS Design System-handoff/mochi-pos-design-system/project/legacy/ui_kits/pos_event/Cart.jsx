...
const qtyBtn = {
  ...
  background: "var(--soft)", color: "var(--label)",
  fontFamily: "inherit", fontSize: 14, fontWeight: 800, cursor: "pointer",
};

function Cart({ lines, customer, onCustomer, onInc, onDec, onRemove, onClear, onCharge }) {
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "16px 18px 10px" }}>
        <span className="eyebrow">CART · {itemCount} items</span>
      ...
      <div style={{ padding: "14px 18px 18px", borderTop: "1px solid var(--line)", background: "var(--panel-strong)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14 }}>
          <span style={{ fontSize: 13, fontWeight: 800, letterSpacing: ".06em", textTransform: "uppercase", color: "var(--muted-warm)" }}>Total</span>
          <Money value={subtotal} size={28} weight={900} />
        </div>
